<template>
  <section class="space-y-12 border-x dark:border-gray-800 max-w-5xl mx-auto py-12">
    ...
    <div class="px-6 md:px-12">
      <div class="grid gap-4 md:grid-cols-3">
        <div
          ...
          :key="metric.label"
          class="rounded-2 border border-border dark:border-gray-800 bg-gray-200 dark:bg-gray-950 p-6 transition-all duration-200 hover:border-primary/20"
    ...
    <div class="px-6 md:px-12 space-y-4">
      <h2 class="text-2xl font-serif font-bold tracking-tight">How it works</h2>
    ...
    <!-- Tech stack -->
    <div class="px-6 md:px-12 space-y-4">
      <h2 class="text-2xl font-serif font-bold tracking-tight">Stack</h2>
